...
**Note:** our testing injected ~40 messages into the live feed (incl. a 100 KB spam msg, out-of-range timestamps, and PII-smuggling reports) — the app state should be reset before final judging.
